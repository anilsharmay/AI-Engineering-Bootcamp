...
def create_helpfulness_agent(
    ...
    """Create a helpfulness-checking LangGraph agent with iterative refinement.
    
    This agent evaluates its responses and continues iterating if the response
    is not helpful, up to a safe limit.
